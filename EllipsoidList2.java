...
*the list and an array of Ellipsoid
*objects, and the number of Ellipsoid
*objects in the array.
*@author Caroline Kirkconnell
*@version 2/14/2020
*/
public class EllipsoidList2 {
String listName; //var1
Ellipsoid[] list; //var2
int var3 = 0; //var3
    ...
    */
   public EllipsoidList2(String listNameIn, Ellipsoid[] listIn, int var3In) {
      var1 = listNameIn;
      var2 = listIn;
      var3 = var3In;
   }
...
for(int i = 0; i < var3; i++)
   ...
   totalV += list[i].volume();
}
return totalV;
}

summaryInfo method does not need to be changed at all

getList will be exactly same except method declaration.

public Ellipsoid[] getList()
{
   return list; //2nd instance variable
}

public EllipsoidList2 readFile(String fileName)
   throws File.....
   
}
   //scanner scanFile
   Ellipsoid[] elVar = new Ellipsoid[100];
   int numE1 = 0
   ...
   //b
   //c
   //object of Ellipsoid(label, a, b, c);
   arrList[numE1] = object;
   numE1++;
   {
   EllipsoidList2 eObj = EllipsoidList2(name, object, numE1);
   return eObj;
   }
}
public Ellipsoid findEllipsoid(String labelIn)
{
   Ellipsoid yourVar = null;
      for(int i = 0; i < var3; i++;)
      {
       if(var2[i].getLabel().equalsIgnoreCase(LabelIn))
      {
      yourVar = var2[i];
      break;
      } 
...
public Ellipsoid deleteEllipsoid(....)
{
   Ellipsoid yourVar = null;
   for(int i = 0; i < var3; i++)
   {
